...
**Pool** — An arrangement where one operator runs the orchestrator and staking, and others contribute
GPUs under that identity.
...
**Treasury** — An on-chain fund (currently a 10% reward cut) for community/public-goods spending,
governed by proposal.
